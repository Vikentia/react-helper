...
function Router() {
    return (
        <div className="content-block">
            <h2 className="content-title">Router</h2>
        ...
        `}</code></pre>
            ...
            <div className="text-block">
                <p>Компонент-оболочка для любых маршрутов, которые мы хотим отобразить, называется Routes. Внутри Routes мы будем использовать
                    компонент Route для каждой страницы, которую хотим отобразить. </p>
            </div>
            <div className="code-block">
                <pre><code>{`
            import React from "react";
